...
|---|---|---|---|---|---|---|---|
| 1 | Warden Sister Othetha | Major | Ashen Wardens | Reach/Hollowmere | Senior rite-keeper | T2 noncombat | `MAJOR_NPCS.md` |
| 2 | Warden Brother Hale | Major | Ashen Wardens | Hollowmere/road | Junior Warden; companion | Companion (Priest-lite) | `MAJOR_NPCS.md` |
| 3 | Mother Calla Vyre | Major | Cinder Ledger | Caradril/Hollowmere | Ledger matriarch | T2 noncombat | `MAJOR_NPCS.md` |
| 4 | Factor Domic Sael | Major | Cinder Ledger | Hollowmere | Local factor | T3 noncombat | `MAJOR_NPCS.md` |
| 5 | Grandmother Wend | Major | Mourners' Circle | Hollowmere | Eldest grief-keeper | T2 noncombat | `MAJOR_NPCS.md` |
| 6 | Iola Wend | Major | Mourners' Circle | Hollowmere | Wend's apprentice | T3 noncombat | `MAJOR_NPCS.md` |
| 7 | Reeve Marda Coalmont | Major | Reachward Compact | Hollowmere | Town reeve | T2 (can fight) | `MAJOR_NPCS.md` |
| 8 | Councilor Aldous Reke | Major | Compact / Hollow Court agent | Hollowmere | Senior councilor | T2 social / T1 forced | `MAJOR_NPCS.md` |
| 9 | The Tallow Man | Major | Gravecallers | Greyfens | Cult speaker | T1 | `MAJOR_NPCS.md` |
| 10 | Sister Knell | Major | Gravecallers | Reach/fens | Recruiter | T2 noncombat | `MAJOR_NPCS.md` |
| 11 | Cole Ashby | Major | Gravecallers | Fens/shrine | Radical zealot | T1 lite | `MAJOR_NPCS.md` |
| 12 | Archivist Quorrin Vane | Major | Concord Remnant | Caradril | Inner-circle scholar | T1 boss-class | `MAJOR_NPCS.md` |
| 13 | Lector Briss | Major | Concord Remnant | Caradril/Reach | Public scholar | T2 noncombat | `MAJOR_NPCS.md` |
