...
- [ ] Begin Stage 10: Quest Library Expansion
  - Why it matters: **Stage 9.5 (Full-Continent NPC Readiness) is complete** — Stage 10 (Quest Library Expansion) is next. The NPC codex now covers the whole continent (94 major / 368 secondary / 953 minor; +44 major / +168 secondary / +432 minor added in Stage 9.5; far-continent majors have voice/relationship/secret routing). The next scaling step per `DEVELOPMENT_STAGES.md` is the quest library (25–40 major campaign quests, 75–150 developed quests, 300–600 hooks/rumors/jobs/events), indexed by level/region/faction/type. Stage 8 faction chains + Stage 9/9.5 NPC casts give quest-givers, rivals, and patrons to build on across all regions.
