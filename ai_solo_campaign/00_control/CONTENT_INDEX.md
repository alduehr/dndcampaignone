...
| Settlement map packets (18) | `06_settlements/settlement_map_packets/SETTLEMENT_*_MAP.md` | mixed | Per-settlement local grid, notable areas, exits, crossings, landmarks. 9 NW cluster (full) + 9 far light-anchors. |
