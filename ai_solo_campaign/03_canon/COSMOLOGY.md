...
- **Creation is native to the Echo, not to any mortal tool.** Nothing mortal-built ever manifests, produces, or constructs anything here — mortal equipment can only measure. The domain itself answers a sufficiently precise measurement by echoing the measured thing back, made real. This is the mechanism behind every "draft," reconstruction, and folded space described below: equipment asks, the Echo answers.
