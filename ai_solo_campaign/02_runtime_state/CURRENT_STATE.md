...
Single-page snapshot of where the campaign stands right now. The AI DM loads this first at the start of every session. Updated at the end of every session.
...
- [`PLAYER_CHARACTER.md`](PLAYER_CHARACTER.md)
- [`CURRENT_LOCATION.md`](CURRENT_LOCATION.md)
