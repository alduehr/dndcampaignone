...
**One deliberate exception (2026-08-31):** the minor god **Veyr**, his domain
**the Echo**, and the extinct mortal order **the Measure** — all introduced in
`the_ell_at_marchwell/` — were promoted to real, registered campaign canon by
explicit user decision (see `NAMING_REGISTRY.md`, `GODS_AND_FAITHS.md`,
`COSMOLOGY.md`, `DM_ONLY_CANON.md`). This is narrow: only those three names
are canon. Marchwell House, its family, Ferris Ambry, and Hesper Wick remain
disposable one-shot-only cast, exactly as before.
