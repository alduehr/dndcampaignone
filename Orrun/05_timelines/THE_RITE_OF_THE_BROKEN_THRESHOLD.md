...
- [`THE_UNMADE_OVERVIEW.md`](THE_UNMADE_OVERVIEW.md) — cosmology this rite operates within
- [`THE_LAST_TELLING.md`](THE_LAST_TELLING.md) — full writeup of the destination
- [`TELLING_TIERS_AND_RANDOM_TABLES.md`](TELLING_TIERS_AND_RANDOM_TABLES.md) — generating Near/Far Tellings
- [`NPCS_OF_THE_UNMADE.md`](NPCS_OF_THE_UNMADE.md) — where to find Unmade glass and Fray-Walkers
