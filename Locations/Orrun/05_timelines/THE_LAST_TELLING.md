...
Every region file in [`../01_geography/regions/`](../01_geography/regions/) carries its own local name under a "Local Name For The Last Telling" heading, so the right word is available wherever play happens to be.
...
- [`UNMADE_ENCOUNTERS.md`](UNMADE_ENCOUNTERS.md)
- [`NPCS_OF_THE_UNMADE.md`](NPCS_OF_THE_UNMADE.md)
