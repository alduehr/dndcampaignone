...
- [`CONTINENT_OVERVIEW.md`](CONTINENT_OVERVIEW.md) — the shape of the world these routes cross
- [`regions/`](regions/) — terrain, custom, and local conditions region by region
- [`../02_settlements/`](../02_settlements/) — the towns at the ends of these roads
- [`../04_bestiary/`](../04_bestiary/) — wandering threats and hazards by terrain
